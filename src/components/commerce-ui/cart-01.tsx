...
const DEFAULT_PRODUCTS: CartProduct[] = [
	...
	{
		id: "prod-2",
		imageUrl: "https://raw.githubusercontent.com/stackzero-labs/ui/refs/heads/main/public/placeholders/watch-1.jpg",
		name: "Smart Watch",
		price: 129.99,
		quantity: 2
	}
		...
		<div className="w-full max-w-4xl rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
			...
			{isLoading && (
				<div className="flex flex-col items-center justify-center p-12 text-center">
					<ReloadIcon className="h-10 w-10 animate-spin text-blue-600 dark:text-blue-400" />
			...
			{!isLoading &&
				...
				(isCartEmpty ? (
					<div className="flex flex-col items-center justify-center p-12 text-center">
						...
						<h2 className="mb-2 text-xl font-semibold text-gray-900 dark:text-gray-100">Your shopping cart is empty</h2>
					...
					<div className="divide-y divide-gray-200 dark:divide-gray-800">
						{products.map((product) => (
							<div key={product.id} className="grid grid-cols-[80px_1fr_auto_auto_auto] items-center gap-4 p-6">
			...
			{!isLoading && !errorMessage && !isCartEmpty && (
				<div className="bg-gray-50 p-6 dark:bg-gray-800/50">
					<h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-gray-100">Order Summary</h2>
