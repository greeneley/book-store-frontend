...
export const BookDetail = () => {
	...
	const settings = {
		...
		customPaging: function () {
			return <a>{/*<Image src={'public/asset/books/Midnight.svg'} rounded />*/}</a>;
		}
	};
	return (
		<>
						...
						<form>
							<div className="text-md-center">
								...
								<span className="first_status product_sku">
									Mã sản phẩm:
									<span className="status_name product-sku text-[#007bff]" itemProp="sku">
										8935074133045
									</span>
								</span>
							</div>
							<div className="flex items-center flex-wrap px-0 gap-4">
								<span className="special-price">
									<span className="text-xl text-red-500 font-bold">{convertToCurrency(price)}</span>
								</span>
								<span className="old-price">
									<del className="text-[#979797] ml-2 font-normal text-lg">{convertToCurrency(originalPrice)}</del>
								</span>
								...
								<div className="text-sm w-auto">
									(Tiết kiệm: <span className="text-red-500">{convertToCurrency(originalPrice - price)}</span>)
								</div>
							</div>
							...
							<div className="flex flex-wrap mb-2 gap-3">
								<Button
									...
									<h5>MUA NGAY</h5>
									<span className="font-light text-sm">Giao hàng tận nơi, Freeship cho đơn hàng trên 299K</span>
								</Button>
							...
							<p className="mb-0 text-center">
								Gọi đặt mua{" "}
								<a href="tel:07.07.26.18.25" className="font-bold text-[#007bff]">
									07.07.26.18.25
								</a>{" "}
					...
					<div>
						<ul className="border-0 p-3 m-0 text-sm flex flex-col">
							<li className="flex items-start">
								...
								<div className="media-body">FreeShip 35k cho đơn hàng trên 299k</div>
							</li>
							<li className="flex items-start">
								<div className="mr-2">
									<img
								...
								<div className="media-body">Thanh toán online qua VNpay, MoMo,...</div>
							</li>
						</ul>
					</div>
				</div>
